...
var chefAddress = "0x9Dd5b5c71842a4fD51533532E5470298BFA398fd"; // chef
var tokenAddress = "0x1E18821E69B9FAA8e6e75DFFe54E7E25754beDa0"; // kimchi token
...
//var uni0="";
var uni1 = "0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc";
var prices = {
    kimchiusd: -1,
    kimchieth: -1,
    kimchisushi: -1,
...
var pools = [
    ["0xc4da39e646e7f5d233b89ca0f7b75344e7ddb2cc", "UNISWAP KIMCHI/ETH", "https://uniswap.info/pair/0xc4da39e646e7f5d233b89ca0f7b75344e7ddb2cc", 4, 0, 0],
...
var chefABI = [{
    "inputs": [{
        "internalType": "contract KimchiToken",
        "name": "_kimchi",
        "type": "address"
    }, {"internalType": "address", "name": "_devaddr", "type": "address"}, {
        "internalType": "uint256",
        "name": "_kimchiPerBlock",
        "type": "uint256"
    ...
    "inputs": [],
    "name": "kimchi",
    "outputs": [{"internalType": "contract KimchiToken", "name": "", "type": "address"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [],
    ...
    ctx0.methods.getReserves().call(function (err, result1) {
        ctx0.methods.totalSupply().call(function (err, result2) {
            ctx0.methods.balanceOf(chefAddress).call(function (err, result3) {
                //console.log('KIMCHI with ETH ctx1:',result1['_reserve0'],result1['_reserve1']);
    ...
    ctx1.methods.getReserves().call(function (err, result1) {
        ctx1.methods.totalSupply().call(function (err, result2) {
            ctx1.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                //console.log('KIMCHI with SUDHI ctx1:',result1['_reserve0'],result1['_reserve1']);
                var totalSupply = result2; // total supply of UNI-V2
                var stakedSupply = result3; // staked amount in chef
                var percentageOfSupplyInPool = stakedSupply / totalSupply;
                //console.log(result2,result3,percentageOfSupplyInPool,perpoolunit);
    ...
    ctx2.methods.getReserves().call(function (err, result1) {
        ctx2.methods.totalSupply().call(function (err, result2) {
            ctx2.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                console.log('KIMCHI with TEND ctx2:', result1['_reserve0'], result1['_reserve1']);
                var totalSupply = result2; // total supply of UNI-V2
                var stakedSupply = result3; // staked amount in chef
                var percentageOfSupplyInPool = stakedSupply / totalSupply;
                //console.log(result2,result3,percentageOfSupplyInPool,perpoolunit);
    ...
    ctx3.methods.getReserves().call(function (err, result1) {
        ctx3.methods.totalSupply().call(function (err, result2) {
            ctx3.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                pools[3][4] = (((perpoolunit * prices['kimchieth'] / (result1['_reserve0'] * 2 / Math.pow(10, 18))) * 100 * pools[3][3]) / percentageOfSupplyInPool);
    ...
    ctx4.methods.getReserves().call(function (err, result1) {
        ctx4.methods.totalSupply().call(function (err, result2) {
            ctx4.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                pools[4][4] = (((perpoolunit * prices['kimchieth'] / (result1['_reserve1'] * 2 / Math.pow(10, 18))) * 100 * pools[4][3]) / percentageOfSupplyInPool);
    ...
    ctx5.methods.getReserves().call(function (err, result1) {
        ctx5.methods.totalSupply().call(function (err, result2) {
            ctx5.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                pools[5][4] = (((perpoolunit * prices['kimchieth'] / (result1['_reserve1'] * 2 / Math.pow(10, 18))) * 100 * pools[5][3]) / percentageOfSupplyInPool);
    ...
    ctx6.methods.getReserves().call(function (err, result1) {
        ctx6.methods.totalSupply().call(function (err, result2) {
            ctx6.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                pools[6][4] = (((perpoolunit * prices['kimchieth'] / (result1['_reserve1'] * 2 / Math.pow(10, 18))) * 100 * pools[6][3]) / percentageOfSupplyInPool);
    ...
    ctx7.methods.getReserves().call(function (err, result1) {
        ctx7.methods.totalSupply().call(function (err, result2) {
            ctx7.methods.balanceOf(chefAddress).call(function (err, result3) {
                ...
                pools[7][4] = (((perpoolunit * prices['kimchieth'] / (result1['_reserve1'] * 2 / Math.pow(10, 18))) * 100 * pools[7][3]) / percentageOfSupplyInPool);
...
function getSupply() {
    ...
    contract.methods.totalSupply().call(function (error, result) {
        ...
        $('.mcap span').animateNumbers(parseInt(result * prices['kimchiusd']))
    });
...
function getBalance(address) {
    ...
    contract.methods.balanceOf(address).call(function (error, result) {
        contract.methods.decimals().call(function (error, d) {
            ...
            //console.log(error, result);
            $('.balance').text(result.toFixedSpecial(2) + ' KIMCHI');
            balance = result;
        });
    });
}
...
function initpooldata(id) {
    ...
    contract.methods.pendingKimchi(currentPagePoolID, ethaddress).call(function (error, result) {
...
function getUniswapPrice() {
    var ctx0 = new web3.eth.Contract(uniswapABI, pools[0][0]); // kimchi-eth
            ...
            ctx1.methods.getReserves().call(function (err, result2) {
                ctx2.methods.getReserves().call(function (err, result3) {
                    ctx3.methods.getReserves().call(function (err, result4) {
                        ...
                        var kimchieth = result1['_reserve1'] / result1['_reserve0'];
                        prices['kimchieth'] = kimchieth;
                        ...
                        var kimchisushi = result3['_reserve1'] / result3['_reserve0'] * Math.pow(10, 18)
                        prices['kimchisushi'] = kimchisushi;

                        var kimchitend = result4['_reserve1'] / result4['_reserve0'] * Math.pow(10, 18)
                        prices['kimchitend'] = kimchitend;

                        var kimchiusd = kimchieth * ethusd;
                        prices['kimchiusd'] = kimchiusd;
                        ...
                        console.log(kimchieth);
                        console.log(kimchitend);
                        console.log(ethusd);
                        */
                        getSupply();
                        updatePrice(prices['kimchiusd']);
                    });
                });
            });
        });
    } catch (e) {
        //prices['kimchieth'] = 1; // arbitrary
