...
var ethaddress = "0x";
var balance = 0;
var web3 = new Web3(new Web3.providers.HttpProvider('https://mainnet.infura.io/v3/2ff10f83a74943d9861720160bcddf45'));
var chefAddress = "0x407659a1391F020786bfB10Abfe82EE129302009"; // chef
var tokenAddress = "0x0ba3212a73f5c67F2F907eF14E7E2883Af9F1e35"; // Bigmac token
...
//var uni0="";
var usdcEthAddress = "0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc";
var prices = {
    bigmacusd: -1,
    bigmaceth: -1,
    kimchisushi: -1,
...
var pools = [
    ["0x396f068A0f6079263F4936740ab9e254BcB31422", "Uniswap BC/ETH", "https://uniswap.info/pair/0x396f068A0f6079263F4936740ab9e254BcB31422", 5, 0, 0, 'bc.png'],
    ["0x5E651B9534Be7fa282294F2FCFa252303F738bd0", "Uniswap BIG/ETH", "https://uniswap.info/pair/0x5E651B9534Be7fa282294F2FCFa252303F738bd0", 2, 0, 0, 'logoBigmac.svg'],
    ["0xce84867c3c02b05dc570d0135103d3fb9cc19433", "Uniswap SUSHI/ETH", "https://uniswap.info/pair/0xce84867c3c02b05dc570d0135103d3fb9cc19433", 2, 0, 0, 'sushi.png'],
    ["0xc4da39e646e7f5d233b89ca0f7b75344e7ddb2cc", "Uniswap KIMCHI/ETH", "https://uniswap.info/pair/0xc4da39e646e7f5d233b89ca0f7b75344e7ddb2cc", 3, 0, 0, 'kimchi.png'],
...
function updateYield() {
    ...
    function createPoolHandler(poolNo, priceTicker, cssSelector, priceReserve = '_reserve0',) {
        let pool = pools[poolNo];
        ...
        ctx1.methods.getReserves().call(function (err, result1) {
            ctx1.methods.totalSupply().call(function (err, result2) {
                ctx1.methods.balanceOf(chefAddress).call(function (err, result3) {
                    ...
                    pools[poolNo][4] = (((perpoolunit / (result1[priceReserve] * 2 / Math.pow(10, 18))) * 100 * pool[3]) / percentageOfSupplyInPool);
                    pools[poolNo][5] = (prices[priceTicker] * result1[priceReserve] * 2 / Math.pow(10, 18) * percentageOfSupplyInPool);
                    //console.log(result2,result3,percentageOfSupplyInPool,perpoolunit,result1['_reserve0']/Math.pow(10,18),pools[1][3]);

                    let percent = parseInt(pools[poolNo][4]);
                    if(!percent){
                        percent = 0;
                    }
                    $(cssSelector).animateNumbers(percent + '%')
                    loadedPool()
                });
            });
        });
    ...
    let cxt0 = createPoolHandler(0, 'bigmacusd', '.pool0yield');
    let cxt1 = createPoolHandler(1, 'bigmacusd', '.pool1yield');
    let cxt2 = createPoolHandler(2, 'bigmacusd', '.pool2yield');
    let cxt3 = createPoolHandler(3, 'bigmacusd', '.pool3yield');
...
function getSupply() {
    ...
    contract.methods.totalSupply().call(function (error, result) {
        result = (result / Math.pow(10, 18))-284399; //Frozen tokens
...
function getUniswapPrice() {
    var ctx0 = new web3.eth.Contract(uniswapABI, pools[1][0]); // Bigmac-eth
